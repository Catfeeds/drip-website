...
<head>
    ...
    <title>水滴打卡管理平台 - @yield('title')</title>
    @section('css')
...
<div class="wrapper">
    <header class="main-header">
        <a href="" class="logo">
            ...
            <span class="logo-lg"><b>水滴</b>打卡</span>
        </a>
        {{-- Navigation Bar --}}
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017 <a href="http://www.growu.me">格吾社区</a>.</strong> All rights
        reserved.
    </footer>
</div>
